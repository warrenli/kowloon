...
#          assigns[:user].login.should eql(user.login)
  ...
  describe "responding to PUT update" do
    before do
      @siteadmin1 = User.make( :login => 'siteadmin1', :email => 'siteadmin1@example.com')
      @siteadmin1.has_role 'site_admin'
      @siteadmin2 = User.make( :login => 'siteadmin2', :email => 'siteadmin2@example.com')
      @siteadmin2.has_role 'site_admin'
      @adminone = User.make( :login => 'adminone', :email => 'adminone@example.com')
      @adminone.has_role 'admin', User
      @admintwo = User.make( :login => 'admintwo', :email => 'admintwo@example.com')
