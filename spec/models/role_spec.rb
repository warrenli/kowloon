...
describe Role do
  ...
  describe "with scopes - application, class, instance" do
    before do
      @site_admin = User.create!( :login => "siteadmin",
      ...
      @user_admin = User.create!( :login => "useradmin",
      ...
      @user_modulator = User.create!( :login => "usermodulator",
                                     :email => "usermodulator@example.com",
                                     :password => "password",
                                     :password_confirmation=> "password",
                                     :active => true)

      @simple_user = User.create!( :login => "helloworld",
